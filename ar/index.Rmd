...
Currently showing `r dim(ar[ar$country_id=="ZMB",])[1]` camps and `r dim(zmb)[1]` villages. Village points are colored by camp (i.e. each camp is a different color). In bright red on the map and in the table below are villages with -- possibly -- bad coordinates (please check and report back).
...
These `r nrow(zmb[zmb$village %in% bad,])` village are either located outside Zambia, or are quite remote from the rest of the camp, else they could be duplicates.
