...
selectInput("cat", "Select a sub-category (`cat2`)", cat)
...
output$hot <- renderRHandsontable({
  ...
  values$hot <- df
  rhandsontable(df, readOnly=F, rowHeaders=F, width=860, stretchH="all",
    highlightCol=T, highlightRow=T,
    columnSorting=T, manualColumnResize=T, fixedColumnsLeft=1) %>%
    hot_cols(list(
